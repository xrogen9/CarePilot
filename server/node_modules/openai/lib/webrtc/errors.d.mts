...
export type WebRTCErrorCode = 'invalid_state' | 'not_open' | 'send_failed' | 'invalid_message' | 'signaling_failed' | 'negotiation_failed' | 'transport_failed' | 'connection_closed' | 'timeout' | 'aborted' | 'unsupported_environment';
...
export declare class WebRTCError extends OpenAIError {
    /** Distinguishes this error from API errors and application callback exceptions. */
    readonly name = "WebRTCError";
