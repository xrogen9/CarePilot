    ...
    constructor(channel) {
        ...
        this.onError = (cause) => {
            ...
            this.connectionEvents.emit({
                type: 'error',
                fatal: false,
                error: new WebRTCError('transport_failed', 'transport', 'The WebRTC data channel reported an error.', cause),
            });
        };
        this.onOpen = () => {
            if (!this.disposed) {
...
//# sourceMappingURL=data-channel.mjs.map