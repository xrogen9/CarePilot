...
export type RunnableFunctionWithParse<Args extends object, ToolContext = unknown> = {
     ...
     */
    function: (args: Args, runner: ChatCompletionRunner<unknown> | ChatCompletionStreamingRunner<unknown>, toolContext: ToolContext) => PromiseOrValue<unknown>;
    /**
...
export type RunnableFunctionWithoutParse<ToolContext = unknown> = {
     ...
     * @returns A value that the runner serializes into a tool-result message.
     */
    function: (args: string, runner: ChatCompletionRunner<unknown> | ChatCompletionStreamingRunner<unknown>, toolContext: ToolContext) => PromiseOrValue<unknown>;
    /**
     * The parameters the function accepts, described as a JSON Schema object.
     */
    parameters: JSONSchema;
...
export type RunnableFunction<Args extends object | string, ToolContext = unknown> = Args extends string ? RunnableFunctionWithoutParse<ToolContext> : Args extends object ? RunnableFunctionWithParse<Args, ToolContext> : never;
...
export type RunnableToolFunctionWithContext<ToolContext> = {
    ...
    function: {
        ...
        function: (args: any, runner: ChatCompletionRunner<unknown> | ChatCompletionStreamingRunner<unknown>, toolContext: ToolContext) => PromiseOrValue<unknown>;
...
export declare function isRunnableFunctionWithParse<Args extends object, ToolContext = unknown>(fn: any): fn is RunnableFunctionWithParse<Args, ToolContext>;
...
export type RunnableFunctions<FunctionsArgs extends BaseFunctionsArgs, ToolContext = unknown> = [
    any[]
] extends [FunctionsArgs] ? readonly RunnableFunction<any, ToolContext>[] : {
    [Index in keyof FunctionsArgs]: FunctionsArgs[Index] extends object | string ? RunnableFunction<FunctionsArgs[Index], ToolContext> : FunctionsArgs[Index];
};
...
export type RunnableTools<FunctionsArgs extends BaseFunctionsArgs, ToolContext = unknown> = [any[]] extends [
    ...
    [Index in keyof FunctionsArgs]: FunctionsArgs[Index] extends object | string ? RunnableToolFunction<FunctionsArgs[Index], ToolContext> : FunctionsArgs[Index];
};
/**
