...
class BedrockSigV4Auth {
    ...
    async prepareRequest(request, context) {
        ...
        await (0, bedrock_1.prepareBedrockAuth)(request, context, {
            resolve: () => this.signatureV4().sign({
