...
export declare class Templates extends APIResource {
     ...
     * ```
     */
    create(body?: TemplateCreateParams | null | undefined, options?: RequestOptions): APIPromise<EnvironmentTemplate>;
    /**
     ...
     * ```
     */
    update(environmentTemplateID: string, body?: TemplateUpdateParams | null | undefined, options?: RequestOptions): APIPromise<EnvironmentTemplate>;
    /**
     ...
     * ```
     */
    list(query?: TemplateListParams | null | undefined, options?: RequestOptions): PagePromise<EnvironmentTemplatesPage, EnvironmentTemplate>;
    /**
...
export interface EnvironmentTemplate {
     ...
     */
    files: Array<EnvironmentTemplate.HostedTemplateFileResourceFileID | EnvironmentTemplate.HostedTemplateFileResourceInline>;
    /**
     ...
     */
    skills: Array<EnvironmentTemplate.HostedTemplateSkillResourceSkillReference | EnvironmentTemplate.HostedTemplateSkillResourceInline>;
    /**
...
export declare namespace EnvironmentTemplate {
     ...
     */
    interface HostedTemplateFileResourceFileID {
        /**
     ...
     */
    interface HostedTemplateFileResourceInline {
        /**
         * The file's absolute path inside the environment.
         */
        path: string;
     ...
     */
    interface HostedTemplateSkillResourceSkillReference {
        /**
     ...
     */
    interface HostedTemplateSkillResourceInline {
        /**
