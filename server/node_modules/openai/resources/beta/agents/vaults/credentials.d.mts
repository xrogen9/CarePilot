...
import * as VaultsAPI from "./vaults.mjs";
...
export declare class Credentials extends APIResource {
     ...
     * ```
     */
    list(vaultID: string, query?: CredentialListParams | null | undefined, options?: RequestOptions): PagePromise<CredentialsPage, Credential>;
    /**
 ...
 * secrets.
 */
export type CredentialAuth = CredentialAuth.VaultCredentialAuthResourceMcpOauth | CredentialAuth.VaultCredentialAuthResourceStaticBearer;
 ...
 */
export type CredentialAuthCreateParam = CredentialAuthCreateParam.CreateVaultCredentialAuthParamMcpOauth | CredentialAuthCreateParam.CreateVaultCredentialAuthParamStaticBearer;
 ...
 * server.
 */
export type CredentialAuthRotateParam = CredentialAuthRotateParam.RotateVaultCredentialAuthParamMcpOauth | CredentialAuthRotateParam.RotateVaultCredentialAuthParamStaticBearer;
