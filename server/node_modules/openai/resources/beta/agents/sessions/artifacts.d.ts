...
export declare class Artifacts extends APIResource {
     ...
     * ```
     */
    retrieve(artifactID: string, params: ArtifactRetrieveParams, options?: RequestOptions): APIPromise<SessionArtifact>;
    /**
     ...
     * ```
     */
    list(sessionID: string, query?: ArtifactListParams | null | undefined, options?: RequestOptions): PagePromise<SessionArtifactsPage, SessionArtifact>;
    /**
     ...
     * ```
     */
    delete(artifactID: string, params: ArtifactDeleteParams, options?: RequestOptions): APIPromise<SessionArtifactDeleted>;
    /**
