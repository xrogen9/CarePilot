...
export declare class Forks extends APIResource {
}
/**
 ...
 * session.
 */
export type ForkClientEvent = LiveAPI.ForkSessionStartEvent | LiveAPI.SessionUpdateEvent | LiveAPI.InputAudioAppendEvent | LiveAPI.InputAudioMuteEvent | LiveAPI.InputAudioUnmuteEvent | LiveAPI.InstructionsAppendEvent | LiveAPI.ThinkingAppendEvent | LiveAPI.CommentaryAppendEvent | LiveAPI.ResponseItemCreateEvent | LiveAPI.ResponseCreateEvent | LiveAPI.SessionCloseEvent;
/**
 ...
 */
export type ForkServerEvent = LiveAPI.SessionStartedEvent | LiveAPI.SessionUpdatedEvent | LiveAPI.InputAudioMutedEvent | LiveAPI.InputAudioUnmutedEvent | LiveAPI.InstructionsAppendedEvent | LiveAPI.ThinkingAppendedEvent | LiveAPI.CommentaryAppendedEvent | ForkServerEvent.SessionInputAudioAppend | LiveAPI.OutputAudioDeltaEvent | LiveAPI.InputTranscriptDeltaEvent | LiveAPI.OutputTranscriptDeltaEvent | LiveAPI.DelegationCreatedEvent | LiveAPI.ResponseEvent | LiveAPI.SessionUsageUpdatedEvent | LiveAPI.SessionClosedEvent | LiveAPI.ErrorEvent | LiveAPI.InfoEvent | ForkServerEvent.TransportDtmfReceived | ForkServerEvent.TransportDtmfSend | ForkServerEvent.TransportRinging | ForkServerEvent.TransportAnswered | ForkServerEvent.TransportFailed;
export declare namespace ForkServerEvent {
    /**
...
//# sourceMappingURL=forks.d.mts.map