...
exports.ForksEmitter = exports.WebSocketError = void 0;
...
class ForksEmitter extends EventEmitter_1.EventEmitter {
...
exports.ForksEmitter = ForksEmitter;
function buildURL(client, parameters) {
    const { session_id: path0, ...query } = parameters;
    const endpoint = (0, path_1.path) `/live/sessions/${path0}/fork`;
