import { ForksEmitter, ForksStreamMessage } from "./internal-base.js";
...
export declare abstract class ForksWSBase<TSocket extends WebSocketLike> extends ForksEmitter {
     ...
     * ```
     */
    stream(): AsyncIterableIterator<ForksStreamMessage>;
    [Symbol.asyncIterator](): AsyncIterableIterator<ForksStreamMessage>;
    private _connect;
