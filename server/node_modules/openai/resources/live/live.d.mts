...
import { SessionAcceptParams, SessionForkParams, SessionForkResponse, SessionReferParams, SessionRejectParams, Sessions } from "./sessions.mjs";
import * as ResponsesAPI from "../responses/responses.mjs";
import * as ForksAPI from "./forks/forks.mjs";
import { ForkClientEvent, ForkServerEvent, Forks } from "./forks/forks.mjs";
import * as SidebandAPI from "./sideband/sideband.mjs";
import { ConnectClientEvent, ConnectServerEvent, Sideband, SidebandConnectParams } from "./sideband/sideband.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class Live extends APIResource {
    sideband: SidebandAPI.Sideband;
    forks: ForksAPI.Forks;
 ...
 */
export type BuiltInVoice = 'alloy' | 'ash' | 'ballad' | 'beacon' | 'bossa' | 'cedar' | 'cinder' | 'coral' | 'delta' | 'echo' | 'gleam' | 'marin' | 'meridian' | 'quartz' | 'ripple' | 'sage' | 'shimmer' | 'stone' | 'tempo' | 'verse' | 'vesper' | 'willow';
/**
 ...
 */
export type ClientEvent = SessionStartEvent | SessionUpdateEvent | InputAudioAppendEvent | InputAudioMuteEvent | InputAudioUnmuteEvent | InstructionsAppendEvent | ThinkingAppendEvent | CommentaryAppendEvent | ResponseItemCreateEvent | ResponseCreateEvent | SessionCloseEvent;
/**
...
export declare namespace DelegationCreatedEvent {
    /**
     * The delegated work identifier and destination. This object contains metadata,
     * not the task text.
     */
...
export declare namespace ForkSessionConfig {
    /**
     * Audio format for a WebSocket fork. WebRTC forks negotiate their audio format and
     * must omit this field.
     */
...
export declare namespace InitialItem {
    /**
...
export declare namespace MediaSessionConfig {
    /**
     * Startup audio configuration. WebRTC and SIP negotiate their audio format on the
     * media transport.
     */
...
export declare namespace MediaSessionForkConfig {
    /**
     * Update the Responses backend for an existing Live session without changing
     * delegation ownership.
     */
...
export interface ResponsesDelegationConfig {
     ...
     * the Live model.
     */
    tool_choice?: 'auto' | 'none' | 'required' | ResponsesDelegationConfig.LiveFunctionToolChoiceParam | ResponsesDelegationConfig.LiveMCPToolChoiceParam;
    /**
...
export declare namespace ResponsesDelegationConfig {
    /**
     * Reasoning settings passed to each delegated Responses request.
     */
    interface Reasoning {
    ...
    interface LiveFunctionToolChoiceParam {
        name: string;
        type: 'function';
    }
    interface LiveMCPToolChoiceParam {
        name: string;
        server_label: string;
        type: 'mcp';
    }
...
export interface ResponsesDelegationUpdateConfig {
     ...
     * the Live model.
     */
    tool_choice?: 'auto' | 'none' | 'required' | ResponsesDelegationUpdateConfig.LiveFunctionToolChoiceParam | ResponsesDelegationUpdateConfig.LiveMCPToolChoiceParam;
    /**
     * Tools available to the Responses backend while it handles tasks delegated by the
     * Live model.
     */
...
export declare namespace ResponsesDelegationUpdateConfig {
    /**
     * Reasoning settings passed to each delegated Responses request.
     */
    interface Reasoning {
 ...
 */
export type ServerEvent = SessionStartedEvent | SessionUpdatedEvent | InputAudioMutedEvent | InputAudioUnmutedEvent | InstructionsAppendedEvent | ThinkingAppendedEvent | CommentaryAppendedEvent | ServerEvent.SessionInputAudioAppend | OutputAudioDeltaEvent | InputTranscriptDeltaEvent | OutputTranscriptDeltaEvent | DelegationCreatedEvent | ResponseEvent | SessionUsageUpdatedEvent | SessionClosedEvent | ErrorEvent | InfoEvent | ServerEvent.TransportDtmfReceived | ServerEvent.TransportDtmfSend | ServerEvent.TransportRinging | ServerEvent.TransportAnswered | ServerEvent.TransportFailed;
export declare namespace ServerEvent {
     ...
     */
    interface SessionInputAudioAppend {
        /**
     ...
     * observers.
     */
    interface TransportDtmfReceived {
        event: string;
        event_id: string;
...
export declare namespace SessionUpdateConfig {
    /**
     * Update the Responses backend for an existing Live session without changing
     * delegation ownership.
     */
...
export declare namespace SessionUsageUpdatedEvent {
    /**
     * The latest measured Live context-window usage. Omitted when the context limit is
     * unknown.
     */
...
export declare namespace LiveCreateResponse {
    /**
     * The newly created Live session. Use its ID for session controls and sideband
     * connections.
     */
...
export declare namespace LiveCreateParams {
    /**
     * WebRTC transport with the browser's SDP offer.
     */
    interface Transport {
...
export declare namespace Live {
    export { type AudioFormat as AudioFormat, type BuiltInVoice as BuiltInVoice, type ClientConfig as ClientConfig, type ClientDelegation as ClientDelegation, type ClientEvent as ClientEvent, type CommentaryAppendEvent as CommentaryAppendEvent, type CommentaryAppendedEvent as CommentaryAppendedEvent, type CustomVoice as CustomVoice, type DataChannelConfig as DataChannelConfig, type DelegationCreatedEvent as DelegationCreatedEvent, type Error as Error, type ErrorEvent as ErrorEvent, type ForkSessionConfig as ForkSessionConfig, type ForkSessionStartEvent as ForkSessionStartEvent, type FunctionTool as FunctionTool, type InfoEvent as InfoEvent, type InitialItem as InitialItem, type InputAudioAppendEvent as InputAudioAppendEvent, type InputAudioMuteEvent as InputAudioMuteEvent, type InputAudioMutedEvent as InputAudioMutedEvent, type InputAudioUnmuteEvent as InputAudioUnmuteEvent, type InputAudioUnmutedEvent as InputAudioUnmutedEvent, type InputTranscriptDeltaEvent as InputTranscriptDeltaEvent, type InstructionsAppendEvent as InstructionsAppendEvent, type InstructionsAppendedEvent as InstructionsAppendedEvent, type MediaSessionConfig as MediaSessionConfig, type MediaSessionForkConfig as MediaSessionForkConfig, type OutputAudioDeltaEvent as OutputAudioDeltaEvent, type OutputTranscriptDeltaEvent as OutputTranscriptDeltaEvent, type ResponseCreateEvent as ResponseCreateEvent, type ResponseEvent as ResponseEvent, type ResponseItemCreateEvent as ResponseItemCreateEvent, type ResponsesDelegationConfig as ResponsesDelegationConfig, type ResponsesDelegationUpdateConfig as ResponsesDelegationUpdateConfig, type ServerEvent as ServerEvent, type ServerEventSelector as ServerEventSelector, type SessionCloseEvent as SessionCloseEvent, type SessionClosedEvent as SessionClosedEvent, type SessionConfig as SessionConfig, type SessionResource as SessionResource, type SessionStartEvent as SessionStartEvent, type SessionStartedEvent as SessionStartedEvent, type SessionUpdateConfig as SessionUpdateConfig, type SessionUpdateEvent as SessionUpdateEvent, type SessionUpdatedEvent as SessionUpdatedEvent, type SessionUsage as SessionUsage, type SessionUsageUpdatedEvent as SessionUsageUpdatedEvent, type ThinkingAppendEvent as ThinkingAppendEvent, type ThinkingAppendedEvent as ThinkingAppendedEvent, type LiveCreateResponse as LiveCreateResponse, type LiveCreateParams as LiveCreateParams, };
    export { Sideband as Sideband, type ConnectClientEvent as ConnectClientEvent, type ConnectServerEvent as ConnectServerEvent, type SidebandConnectParams as SidebandConnectParams, };
    export { Forks as Forks, type ForkClientEvent as ForkClientEvent, type ForkServerEvent as ForkServerEvent };
    export { Sessions as Sessions, type SessionForkResponse as SessionForkResponse, type SessionAcceptParams as SessionAcceptParams, type SessionForkParams as SessionForkParams, type SessionReferParams as SessionReferParams, type SessionRejectParams as SessionRejectParams, };
}
