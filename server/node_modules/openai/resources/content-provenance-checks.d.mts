...
export declare class ContentProvenanceChecks extends APIResource {
    /**
     ...
     */
    create(body: ContentProvenanceCheckCreateParams, options?: RequestOptions): APIPromise<ContentProvenanceCheck>;
}
...
export declare namespace ContentProvenanceCheck {
    interface C2PA {
        /**
...
export declare namespace ContentProvenanceChecks {
    export { type ContentProvenanceCheck as ContentProvenanceCheck, type ContentProvenanceCheckCreateParams as ContentProvenanceCheckCreateParams, };
}
//# sourceMappingURL=content-provenance-checks.d.mts.map